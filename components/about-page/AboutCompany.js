...
const mainBody = (
        <section>
            <div>
            <div>
                <h2 class='text-green-800 text-xl'>Company profile</h2>
                <h1 class='py-2'>Mission</h1>
            ...
            <div>
                <h1 class='py-2 '>Social Responsibility</h1>
    ...
    const Body = (
        <section class='bg-white'>
            <div class=' text-opacity-25 md:mx-16 lg:mx-53 py-10  flex justify-center text-justify'>
                <div class='p-26 text-left w-1/2'>
                <h2 class='py-4 text-xl text-green-800'>Vululwani Consulting</h2>
                <p font-bold>
